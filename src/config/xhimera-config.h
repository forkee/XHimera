/* src/config/xhimera-config.h.  Generated from xhimera-config.h.in by configure.  */
/* src/config/xhimera-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.xhimera.net"

/* Define to the full name of this package. */
#define PACKAGE_NAME "XHimera Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "XHimera Core 1.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "xhimera"
