...
#if defined(NDEBUG)
#error "XHimera cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight == 0) {
        nSubsidy = 600001 * COIN;
    } else if (nHeight <= 180 && nHeight > 1) {
        nSubsidy = 0 * COIN;
    } else if (nHeight <= 2400 && nHeight >= 181) {
        nSubsidy = 12 * COIN;
    } else if (nHeight <= 74400 && nHeight >= 2401) {
        nSubsidy = 12 * COIN;
    } else if (nHeight <= 2306400 && nHeight >= 74401) {
        nSubsidy = 10.8 * COIN;
    } else if (nHeight <= 71498400 && nHeight >= 2306401) {
        nSubsidy = 9.72 * COIN;
    } else if (nHeight <= 2216450400 && nHeight >= 71498401) {
        nSubsidy = 8.748 * COIN;
    } else if (nHeight <= Params().LAST_POW_BLOCK() && nHeight >= 2216450401) {
        nSubsidy = 7.8732 * COIN;
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue, int nMasternodeCount)
{
    ...
    if (nHeight <= 2400 && nHeight >= 0) {
        ...
        int64_t mNodeCoins = mnodeman.size() * 50000 * COIN;
